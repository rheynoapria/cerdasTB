...
import com.example.cerdastb.AlarmSet.AlarmReceiver;
import com.example.cerdastb.AlarmSet.LocalData;
import com.example.cerdastb.AlarmSet.NotificationScheduler;
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    NotificationScheduler.setReminder(Alarm.this, AlarmReceiver.class, localData.get_hour(), localData.get_min());
                    ll_set_time.setAlpha(1f);
                } else {
                    Log.d(TAG, "onCheckedChanged: false");
                    NotificationScheduler.cancelReminder(Alarm.this, AlarmReceiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
